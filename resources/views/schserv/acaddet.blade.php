...
<head>
      ...
      <title>add school details s </title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>  @foreach($acad   as $data)
                    <b> <h4> welcome  to "{{$data->acadn}}"</h4><b>
             @endforeach</h1>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                @foreach($acad as $data)   
                                 <h4> ADD further details  to "{{$data->acadn}}"
                                 @endforeach
                              </a>
                           </div>
                          <button> <a href="{{url('/acad')}}">Back </a></button>
                        </div>
                        <div class="panel-body">
                       
                               
                        <form method="post" action='/acaddetadd/{id}'>
                           @csrf	
                            ...
                            <div class="form-group ">
                              ...
                              <input type="text"  class="form-control" name="acadn" value="{{$data->acadn}}">
                                  
                            </div>
                            <label>Academic  Acronym </label>
                            <input type="hidden" class="form-control" name="id" value="{{$data->id}}">
                              <input type="text"  class="form-control" name="acadacr" value="{{$data->acadacr}}">
                            </div>
                            
                        
                            <div class="form-group ">
                              <label>Academic  Head title</label>
                              <input type="text"  class="form-control" name="acadh"  value="{{$data->acadh}}">
                          
                            </div>

                            <div class="form-group ">
                              <label>Academic head fullname</label>
                              <input type="text"  class="form-control" name="acadfn"  value="{{$data->acadfn}}">
                          
                            </div>
                            @endforeach
                              <input type= "submit" value="Submit Unit"> <br>  <br>
                           </form>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">
                                       ...
                                       <th>upload logo</th>
                                       <th>Develop Academic details </th>
                                 ...
                                 <tbody>                             
                                    ...
                                    @forelse($acad as $datda)
                                             ...
                                             <td class="text-right">
                                              <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item ria" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-2"></i> Upload Unit logo </a><br>
                                                        <a class="dropdown-item lumi" href="#" data-toggle="modal" data-target=""><i class="fa fa-upload m-r-2"></i> Upload Director image </a>
                                       ...
                                       <a href="{{url('/acadprofile/'.$datda->id)}}">View & Create Academic profile </a>
                                        </div>
                                          </div>
                     ...
                     <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        @foreach($acad as $data)  
							<td><img src="/storage/acadlogo/{{($data->acadlogo)}}" width="100px", height="100px"></td>
								</div>
								</div>
                       
                           <h5 class="modal-title">Upload Academic Logo</h5>
                        ...
                        <div class="panel-body">
                         ...
                         <form method="post" action='/acadlogo/{id}'  enctype="multipart/form-data">
                                  @csrf	

                                  <div class="col-sm-6 col-md-12">
                                 <div class="form-group"> 
                       <label>Select Unit's logo (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
                       <input type="hidden" name="id" value="{{$data->id}}"> @endforeach
                      <input type="file" class="form-control" name="acadlogo">
                     </div>
                     </div>
      ...
      <div id="realq" class="modal custom-modal fade" role="dialog">
       ...
       <div class="modal-content">
          ...
          <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img"> 
                        <td><img src="/storage/dir2logo/{{($data->dir2logo)}}" width="100px", height="100px"></td>
								</div>
								</div> 
                        <h5 class="modal-title">Upload Director's Image</h5>
  ...
  <form method="post" action='/dir2logo/{id}'  enctype="multipart/form-data">
          @csrf	
 <div class="col-sm-6 col-md-12">
<div class="form-group"> 

  <label>Select Director's logo (png, jpg or jpeg format allowed) <span class="text-danger">*</span></label>
 <input type="hidden" name="id" value="{{$data->id}}">  @endforeach
  <input type="file" class="form-control" name="dir2logo">
  </div>
  </div>
