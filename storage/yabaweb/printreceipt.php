...
$query10 = mysqli_query($conn, "SELECT *  FROM applicants WHERE emal ='$sesmail'");
$query11 = mysqli_query($conn, "SELECT *  FROM payment WHERE emal ='$sesmail'");
...
<!-- Mirrored from thememinister.com/crm/emailmes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2019 13:28:48 GMT -->
<head>
      <meta charset="utf-8">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1> </h1>
                  <small>ONLINE APPLICATION RECEIPT</small>
               </div>
            </section>
            <!-- Main content -->
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 text align="center">APPLICATION FORM RECEIPT</h4>
                              </a>
                           </div>
                        </div>
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           ...
                           <!-- ./Plugin
                              ...
                              content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                        

                                    <?php 
                                          while($row=mysqli_fetch_assoc($query10)){//openning of while braces
                                          $id = $row['id'];
                                          $fulln = $row['fulln'];
                                          $emal = $row['emal'];
                                          $pwd = $row['pwd'];
                                          ...
                                          while($row=mysqli_fetch_assoc($query11)){//openning of while braces
                                          $amount = $row['amount'];
                                          $dpay = $row['paymdate'];
            ...
            <tr>
            <td><img width="100px" src="imagez/<?php echo $pix;?>"></td>
            <td><h1 class="cap"><?php echo $sesfulln;?></h1></td>
         </tr>

           <tr>
               <td> Email</td> 
               <td> <div class= "redtext" > <?php echo $emal;?></td>
            </tr>
             
            <tr>
               <td>Course Of study</td> :  
               <td><div class= "redtext" ><?php echo $course;?></td>
            </tr>
            <tr>
               <td>Programme Of study </td> : 
               <td ><div class= "redtext" ><?php echo $prog;?></td>
            </tr>
            <tr>

               <td>Amount Paid</td>: 
               <td><div class= "redtext" >₦<?php echo $amount;?></td>
            </tr>
            <tr>
               <td>Date of Payment </td>: 
               <td><div class= "redtext" ><?php echo $dpay;?></td>
            </tr>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-users m-r-5"></i> Update table</h3>
                        </div>
                                 ...
                                 <form class="form-horizontal">
                                    <fieldset>
                                       ...
                                       <div class="col-md-6 form-group">
                                          ...
                                          <input type="text" placeholder="Assign" class="form-control">
                                       </div>
                                       <div class="col-md-6 form-group">
               ...
               <div class="modal fade" id="delt" tabindex="-1" role="dialog">
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                           <h3><i class="fa fa-user m-r-5"></i> Delete Email</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal">
                                    <fieldset>
                                       <div class="col-md-12 form-group user-form-group">
                                          <label class="control-label">Delete Email</label>
                                          <div class="pull-right">
