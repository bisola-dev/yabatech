...
$querix = mysqli_query($conn, "UPDATE applicants SET statuz ='Admitted' WHERE id = '$candid'");

$reportalert = '<script type= "text/javascript">
alert("candidate has been admitted successfully.")
</script>';

}

if (isset($_POST['deadmit'])){
   $candid = mysqli_real_escape_string($conn, $_POST['candid']);
...
$queriy = mysqli_query($conn, "UPDATE  applicants SET statuz='Not Admitted' WHERE id='$candid'");
 
     
     $reportalert = '<script type="text/javascript">
        alert("candidate has been de-admitted successfully.")
        </script>';
...
$fesh = mysqli_query($conn, "SELECT * FROM applicants");
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <?php 
                                    while ($row = mysqli_fetch_assoc($fesh)) {
                                       $id = $row['id'];
                                       $fulln = $row['fulln'];
                                       $prog = $row['prog'];
                                       $emal = $row['emal'];
                            ...
                            <div>
                              ...
                              <th><img width="70px" src="imagez/<?php echo $pix;?>" /></th>
