        ...
        <div class="col-sm-12">
          <div class="">
            ...
            <div class="table-responsive">
              <div class="">
               <button class=""><a href="index1.php" class="btn-add">Back to HomePage</a></button>
                ...
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover" border="1px">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                      <form>
                        <input type="hidden" name="ridd" value="<?php echo $rid; ?>">
                      <button type="submit" name="delitt" class="btn btn-add btn-sm ">delete</i></button>
                      </form>
                    </td>
                    </tr>
                    <?php $num++; 
